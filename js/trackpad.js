...
;(function($) {
  ...
  function Plugin(element, options) {
    ...
    function init() {
      ...
      $el.prepend('<div class="tse-scrollbar" style="display: block !important"><div class="drag-handle"></div></div>');
    ...
    function drag(e) {
      ...
      //var scrollPos = dragPerc * $contentEl.outerHeight(true);
    ...
    function resizeScrollbar() {
      var contentSize = sizeAttr === 'height' ? $contentEl.outerHeight(true) : $contentEl.outerWidth();
      ...
      var handleSize = Math.floor(scrollbarRatio * (scrollbarSize - 2)) - 12;
